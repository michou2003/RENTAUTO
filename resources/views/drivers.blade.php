...
<div class="container">
    <div class="row my-5 d-flex justify-content-evenly">
        <form action="{{ route('user.search') }}" method="POST" class="search d-flex col-4 ">
            ...
            @csrf
            <div>
                <input type="search" class="form-control border-0" name="name" value="@php if(isset($_POST['name'])){echo $_POST['name'];}@endphp" required id="" placeholder="Search driver">
            </div>
        ...
        <a href="{{ route('driver.new') }}" class="btn col-2 border" style="background-color: rgb(251, 185, 34);color:white; border-radius: 10px"> + Nouveau chauffeur</a>
    </div>
    <div class="row ">
            ...
            <table class="table table-striped table-responsive rounded">
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td><a href="{{ route('driver.delete_', ['id'=> $driver->id] ) }}"><svg width="20" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="alert alert-danger">
                        Auncun chauffeur n'a ete inscrit
                    </div>
