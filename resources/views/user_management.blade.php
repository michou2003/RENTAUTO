...
<div class="container-fluid">
    <div class="row my-5 d-flex justify-content-evenly">
        ...
        <form action="{{ route('user.filter') }}" method="POST" class="col-4 d-flex ">
            @csrf
            ...
            <table class="table table-striped rounded">
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td><a href="{{ route('user.delete', ['id'=> $user->id] ) }}"><svg width="20" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="alert alert-danger">
                        Auncun utilisateur n'a ete inscrit
                    </div>
